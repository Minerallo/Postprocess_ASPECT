...
paraview_python_script = [path_to_postprocess_ASPECT 'Users_workflow_example/Poulami/Model_extract_global_3D_auto.py'];
models_cluster_directory = '/scratch/projects/bbk00014/model_global_Poulami/';
extracted_models_pvdata_directory = '/Volumes/Jerry/global_models_3d_extract/';
remote_Postprocess_directory = '/scratch/projects/bbk00014/model_global_Poulami/post_process/models/';
remote_Postprocess_scripts = '/scratch/projects/bbk00014/model_global_Poulami/post_process/postprocess_scripts/';
local_access_to_postprocess_directory = '/Users/ponsm/Desktop/bbk00014/model_global_Poulami/post_process/models/';
local_access_to_postprocess_scripts_directory='/Users/ponsm/Desktop/bbk00014/model_global_Poulami/post_process/postprocess_scripts/';
...
model_names = {'14_test_250Ma_3D_test_with_shear_heat_01'};
...
output_directory_name = 'auto_Poulami_14';
...
postprocess_script_path = [path_to_postprocess_ASPECT 'Users_workflow_example/Poulami/Postprocess_auto_generated_Poulami.m'];
...
file_input_sh = [path_to_postprocess_ASPECT 'Users_workflow_example/Poulami/build_autopostprocess_files.m'];
...
fprintf(fid, '\n');
fprintf(fid, 'umount -f ~/Desktop/bbk00014\n');
fprintf(fid, '\n');
fprintf(fid, 'sshfs -o "IdentityFile=/Users/ponsm/.ssh/id_rsa_hlrn" bbkponsm@blogin.hlrn.de:/scratch/projects/bbk00014/ /Users/ponsm/Desktop/bbk00014 -o defer_permissions\n');
fprintf(fid, '\n');
