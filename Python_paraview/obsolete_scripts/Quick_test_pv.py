...
path = '/scratch/usr/bbkponsm/model/globalscale/sphere3d/R01e_Rodinia_2GPa_Mantle_C20MPa_f003_LR/'
# ,
...
n_files_surface = sum(1 for file in os.listdir(output_directory_full2) if 'surface' in file)
...
if index_file == 1 :
# save data
SaveData(output_model_folder + '/surface.csv', proxy=resampleWithDataset1, WriteTimeSteps=0,
