...
for path in path_models:
  ...
  # find source
    ...
    SaveData(output_model_folder + '/surface.csv', proxy=resampleWithDataset1, WriteTimeSteps=1,
        WriteTimeStepsSeparately=1,
        Filenamesuffix='_%.4d',
        PointDataArrays=['Divergence', 'Q Criterion', 'T', 'Vorticity', 'continent', 'current_friction_angles', 'current_yield_stresses', 'density', 'nonadiabatic_temperature', 'principal_stress_direction_1', 'principal_stress_direction_2', 'principal_stress_direction_3', 'shear_stress', 'strain_rate', 'v_phi', 'v_r', 'v_theta', 'velocity', 'viscosity'],
        FieldDataArrays=['TIME'],
        AddTime=1)
...
# elif index_file == 1 or index_file == 2 :    
    ...
    SaveData(output_model_folder +'/lithosphere.csv', proxy=calculator1, WriteTimeSteps=1,
        WriteTimeStepsSeparately=1,
        Filenamesuffix='_%.4d',
        PointDataArrays=['Divergence', 'Gradient', 'Normals', 'Q Criterion', 'T', 'Vorticity', 'continent', 'density', 'depth', 'nonadiabatic_temperature', 'oceanic_age', 'p', 'principal_stress_direction_1', 'principal_stress_direction_2', 'principal_stress_direction_3', 'shear_stress', 'strain_rate', 'v_phi', 'v_r', 'v_theta', 'velocity', 'viscosity'],
        FieldDataArrays=['TIME'],
        AddTime=1)
