...
for path in path_models:
    ...
    folder = path.split('/')[-2]
    output_base_folder = path + 'Postprocess'
  ...
  # find source
    ...
    if index_file == 1 :
        ...
        SaveData(output_model_folder + '/surface.csv', proxy=resampleWithDataset1, WriteTimeSteps=1,
            WriteTimeStepsSeparately=1,
            Filenamesuffix='_%.4d',
            PointDataArrays=['Divergence', 'Q Criterion', 'T', 'Vorticity', 'continent', 'current_cohesions', 'current_friction_angles', 'current_yield_stresses', 'density', 'depth', 'nonadiabatic_temperature', 'p', 'principal_stress_direction_1', 'principal_stress_direction_2', 'principal_stress_direction_3', 'shear_stress', 'specific_heat', 'strain_rate', 'v_phi', 'v_r', 'v_theta', 'velocity', 'viscosity'],
            FieldDataArrays=['TIME'],
            AddTime=1)
        ...
        SaveData(output_model_folder +'/lithosphere.csv', proxy=calculator1, WriteTimeSteps=1,
            WriteTimeStepsSeparately=1,
            Filenamesuffix='_%.4d',
            PointDataArrays=['Divergence', 'Gradient', 'Normals', 'Q Criterion', 'T', 'Vorticity', 'continent', 'density', 'depth', 'nonadiabatic_temperature', 'oceanic_age', 'p', 'principal_stress_direction_1', 'principal_stress_direction_2', 'principal_stress_direction_3', 'shear_stress', 'specific_heat', 'strain_rate', 'v_phi', 'v_r', 'v_theta', 'velocity', 'viscosity'],
            FieldDataArrays=['TIME'],
            AddTime=1)
        ...
        SaveData(output_model_folder +'/depths.csv', proxy=contour3, WriteTimeSteps=1,
            WriteTimeStepsSeparately=1,
            Filenamesuffix='_%.4d',
            PointDataArrays=[ 'T', 'Vorticity', 'density', 'depth', 'nonadiabatic_temperature', 'p', 'principal_stress_direction_1', 'principal_stress_direction_2', 'principal_stress_direction_3', 'shear_stress', 'specific_heat', 'strain_rate', 'v_phi', 'v_r', 'v_theta', 'velocity', 'viscosity'],
            FieldDataArrays=['TIME'],
            AddTime=1)
