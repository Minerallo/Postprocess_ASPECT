% This file can create a topography video from a topography file generated by Aspect for Sphere 3D
% but only one model at a time, 
% I recommend the file topography_sphere_movie_for_model_series.m instead, which is more up-to-date.

clc ; close all; clear all;

path_model = '/Users/ponsm/Desktop/modelblogin/model/globalscale/sphere3d/039_Newworld_fred_simple_LMcompressible_C40MPa_lowres/'
make_video='false';
...
if strcmp(make_video, 'true')
    ...
    videoFilename = 'topography_video.mp4';
