...
path_models =  {'/Users/ponsm/Desktop/Model_sphere/Models_HLRN/R01f_Rodinia_2GPa_Mantle_C10MPa_f005_LR/'};
...
for m = 1:numel(path_models)
    ...
    surface_init = import_surface_sphere(fullfile(path_model, filenames_surface{1}));
