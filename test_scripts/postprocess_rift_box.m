...
% Example
path_models = {['/Users/ponsm/Library/CloudStorage/GoogleDrive-mikpons2@gmail.com/My Drive/Postdoc/collab/Rift_copy/Rift_A02/']}
%     ['/Volumes/Jerry/global_models_3d_extract/R01f_SRW01_1em15_Rodinia_2GPa_Mantle_C10MPa_f005_LR/']}
% {'/Volumes/Jerry/global_models_3d/R01f_SRW01_1em15_Rodinia_2GPa_Mantle_C10MPa_f005_LR/'}
% {'/Volumes/Jerry/global_models_3d/R01f_Rodinia_2GPa_Mantle_C10MPa_f005_LR_SB_f003/'}
% {'/Volumes/Jerry/global_models_3d/R01f_Rodinia_2GPa_Mantle_C10MPa_f005_LR/'};
% {'/Volumes/Jerry/global_models_3d/R01e_Rodinia_2GPa_Mantle_C20MPa_f003_LR/'}
% {'/Volumes/Jerry/global_models_3d/R01f_Rodinia_2GPa_Mantle_C10MPa_f005_LR/'};
% {'/Volumes/Jerry/global_models_3d/R01e_Rodinia_2GPa_Mantle_C20MPa_f003_LR/'};
% {'/Volumes/Jerry/global_models_3d_extract/R01f_Rodinia_2GPa_Mantle_C10MPa_f005_LR/'};
...
selected_output_folder_path = '/Users/ponsm/Library/CloudStorage/GoogleDrive-mikpons2@gmail.com/My Drive/Postdoc/collab/Rift_copy/Postprocess/';
% '/Volumes/Jerry/global_model_3d_postprocess/';
...
additional_postprocesses = {'subduction_and_plume_statistics','continents_VRMS','oceanic_age_statistics'};

% Select which figures to output
% e.g output_additional_maps_figures = {'topography','geofeatures','strain_rate'};
output_additional_maps_figures = {'topography','geofeatures','strain_rate','oceanic_age','divergence'};
...
% is the deepest
plumes_depths_tracking=[440,440,2600];
...
subduction_depths_tracking=[0,440,2600];
plumes_non_adiabatic_tracking_temperature = [100,100,250];% Non adiabatic threshold for plumes for each depths layer
subduction_non_adiabatic_tracking_temperature = [0,-200,-400];%% Non adiabatic threshold for subduction for each depths layer
trenches_elevation_threshold = -4500; %elevation threshold for trenches
...
Interval_of_time_output_for_additional_postprocess = 2.5; %in Myr
    ...
    if strcmp(run_spherical_additional_postprocess, 'true')
            ...
            if init_step == max_step
                ...
                if  strcmp(restart_additional_postprocess,'auto') && (init_step < max_step)
                    [geofeatures] = get_geodynamics_features_statistics(path_model_input, additional_postprocesses,plumes_depths_tracking,subduction_depths_tracking,...
                        ...
                        remove_subductions_to_oceanic_age,init_step,Interval_of_time_output_for_additional_postprocess);
        ...
        if any(strcmp(additional_postprocesses, 'oceanic_age_statistics'))
            try
               ...
               oceanic_age_density_reshape = reshape(oceanic_age_density.Time_with_Pdf_oceanic_age,[251,numel(oceanic_age_density.Time_with_Pdf_oceanic_age)/251]);
               oceanic_age_density_time = oceanic_age_density_reshape(1,:);
               oceanic_age_density_reshape = oceanic_age_density_reshape(2:end, :);
               oceanic_age_distribution = 1:250;
                h = figure;
