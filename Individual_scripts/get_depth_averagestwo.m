function [time_avg,param_avg] = get_depth_averagestwo(path_model, depths_for_average, averaged_parameters)
...
fileID = fopen(filename,'r');
dataArray = textscan(fileID, formatSpec, 'Delimiter', ' ', 'MultipleDelimsAsOne', true, 'TextType', 'string', 'HeaderLines' ,1, 'ReturnOnError', false);
fclose(fileID);
