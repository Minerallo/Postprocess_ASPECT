...
% Example
path_model = '/Users/ponsm/Desktop/Model_sphere/Models_HLRN/P01a_Pangea_1GPa_Mantle_C40MPa_LR/'
...
statistic_parameters = {'RMS','temperature','Mobility','total RMS velocity'};
...
% Python_paraview
run_addtional_postprocess = 'true';
% additional_postprocesses = {'subduction_and_plume_statistics','oceanic_age_statistics','continents_RMS'};
additional_postprocesses = {'subduction_and_plume_statistics','continents_RMS'};
...
if strcmp(run_addtional_postprocess, 'true')
    ...
    [Geodynamics_structures_distribution] = get_geodynamics_features_statistics(path_model, additional_postprocesses);
